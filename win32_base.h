...
static FileData
os_file_read(Arena* arena, String8 file_path){
    FileData result = {0};
    String16 wide_path = os_utf8_to_utf16(arena, file_path);
...
static bool
os_file_write(String8 file_path, FileData file){
    bool result = false;
    ScratchArena scratch = begin_scratch(0, 0);
    String16 wide_path = os_utf8_to_utf16(scratch.arena, file_path);
...
static bool
os_file_delete(String8 full_path){
    ScratchArena scratch = begin_scratch(0, 0);
